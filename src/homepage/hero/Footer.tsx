...
const Footer = () => {
  return (
    <footer id="contact" className="scroll-mt-24 border-t border-[#292347] bg-[#0D0A1F] px-10 py-10 text-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:items-end">
          <a
            ...
            className="flex items-center gap-2.5 text-sm text-[#a8a3c7] transition hover:text-[#7C3AED]"
          >
            <FaLinkedin size={16} />
